...
<html>
	...
	<aside id="colorlib-hero">
		...
		<div class="col-md-4">
			<img src="images/wwd.png" style="width: 100%">
		</div>
			...
			<div class="col-md-8">
				<div id="owl-demo2" style="width: 98%"> <!-- 93.5% -->
					...
					<div class="item">
						<a href="http://ecash.bankmandiri.co.id/cara-pakai-line-pay-e-cash/">
	...
	<div class="colorlib-blog text-center animate-box colorlib-heading">
			<h2 style="text-align: center;">Progress</h2>
			<p style="text-align: center;">PLorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
