				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 text-center">
							<div class="intro">
								<h1>SDLC</h1>
								<h2 style="color: white;">Retail Products</h2>
								<p><span><a href="index.php" style="color: #F8CA37 ">Home</a></span> / <span style="color: gray;">SDLC - Retail Products</span></p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="colorlib-blog">
				<div class="overlay">
					<div class="container">
						...
						<button type="button" class="btn" data-toggle="modal" data-target="#myModal" style="background-color: #F8CA37; color: white;">Add Project</button>
						</div>
						...
						<div class="modal-dialog">
						    <div class="modal-content">
						        ...
						        <div class="modal-footer">
						        	<button class="btn" name="submit"data-dismiss="modal" style="background-color: #F8CA37; color: white;">Submit</button>
				    ...
				    <thead>
				        ...
				        <th style="text-align: center;">Risk Dept</th>
