			...
			<form action="/action_page.php">
			  <div class="container">
				...
				<div class="form-group">   
				    ...
				    <input class="form-control" type="text" placeholder="Enter Full Name" name="full-name" required>
				</div>
				...
				<div class="form-group">
				    ...
				    <select class="form-control" id="sel1" style="background-color: #f1f1f1" required>
